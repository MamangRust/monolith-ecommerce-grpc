...
const file_order_item_order_item_common_proto_rawDesc = "" +
	"\n" +
	"\"order_item/order_item_common.proto\x12\x02pb\x1a\x10common/api.proto\x1a\x1egoogle/protobuf/wrappers.proto\"\xcd\x01\n" +
