...
const file_order_order_common_proto_rawDesc = "" +
	"\n" +
	"\x18order/order_common.proto\x12\x02pb\x1a\x10common/api.proto\x1a\x1egoogle/protobuf/wrappers.proto\"&\n" +
	...
	"\n" +
	"deleted_at\x18\a \x01(\v2\x1c.google.protobuf.StringValueR\tdeletedAt\"k\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12+\n" +
	"\x04data\x18\x03 \x03(\v2\x17.pb.OrderYearlyResponseR\x04data\"\x91\x01\n" +
	...
	"\x04data\x18\x03 \x03(\v2#.pb.OrderYearlyTotalRevenueResponseR\x04dataB4Z2github.com/MamangRust/monolith-ecommerce-shared/pbb\x06proto3"
