...
func NewService(deps *Deps) *Service {
	...
	return &Service{
		...
		TransactionCommand:         NewTransactionCommandService(deps.Ctx, deps.Mencache.TransactionCommandCache, deps.ErrorHandler.TransactionCommandError, deps.Kafka, deps.Repositories.UserQuery, deps.Repositories.MerchantRepository, deps.Repositories.TransactionQueryRepository, deps.Repositories.TransactionCommandRepository, deps.Repositories.OrderQueryRepository, deps.Repositories.OrderItemRepository, deps.Repositories.ShippingAddressQueryRepository, mapper, deps.Logger),
